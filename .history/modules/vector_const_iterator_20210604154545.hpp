...
{
	public:
		typedef ft::Vector::size_type		size_type;
		typedef ft::Vector::Const_Iterator	size_type;
	...
	public:
	    ...
	    Const_Iterator(const Vector<T>* vector, size_type index) : _pvector(vector), _index(index)	{}
