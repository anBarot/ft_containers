...
namespace ft
{
	...
	class Vector
	{
		public:
			...
			typedef ft::VectorConst_Iterator			const_iterator;
			typedef ft::VectorReverse_Iterator			reverse_iterator;
			typedef ft::VectorConst_Reverse_Iterator	const_reverse_iterator;
		...
		public:
			...
			explicit Vector(size_type n, reference val = value_type(), const allocator_type& alloc = allocator_type());
...
ft::Vector<T, Alloc>::Vector(size_type n, reference val = value_type(), const allocator_type &alloc = allocator_type())
