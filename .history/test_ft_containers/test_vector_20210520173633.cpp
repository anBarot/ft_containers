...
// template<typename T>
// void	display_myvector(ft::Vector<T> &myvec)
// {
// 	for (ft::Vector<T>::iterator &it = myvec.begin(); it < myvec.end(); it++)
// 		std::cout << *it << " - ";
// 	std::cout << "Size : " << myvec.size() << std::endl;
// 	std::cout << "Capacity : " << myvec.capacity() << std::endl;
// 	std::cout << "Empty ? " << " : " << myvec.empty() << "\n\n";
// }

template<typename T>
void	display_vector(std::vector<T> &vec)
{
	for (std::iterator &it = vec.begin(); it < vec.end(); it++)
		std::cout << *it << " - ";
