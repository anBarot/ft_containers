...
namespace ft
{
	...
	class Vector
	{
		public:
			...
			typedef VectorConst_Iterator<T>				const_iterator;
			typedef VectorReverse_Iterator<T>			reverse_iterator;
			typedef VectorConst_Reverse_Iterator<T>		const_reverse_iterator;
