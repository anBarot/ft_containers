...
namespace ft
{
	...
	class Vector
	{
		...
		public:
			...
			typedef	const Iterator						vector_const_iterator;
			// typedef	const std::reverse_iterator<T>		reverse_iterator;
			...
			// Iterator
			vector_iterator	begin() { return (Iterator(this, 0)); }
			vector_iterator	end() { return (Iterator(this, this->_size)); }
...
class ft::Vector<T>::Iterator
{
	...
	public:
	    ...
	    vector_iterator &operator++() { ++this->_index; return (*this); }
	    vector_iterator &operator--() { this->_index; return (*this); }
...
template<class T>
typedef typename ft::Vector<T>::vector_iterator	vector_iterator;
