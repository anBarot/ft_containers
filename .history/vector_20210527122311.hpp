...
namespace ft
{
	...
	class Vector
	{
		...
		public:
			...
			~Vector()	{
							this->clear(); 
							_alloc.deallocate(this->_data, this->_size);
						};
...
ft::Vector<T, Alloc>(ft::Vector<T, Alloc>::size_type n, const value_type& val = value_type(), const allocator_type& alloc = allocator_type()) : _size(n)
{
